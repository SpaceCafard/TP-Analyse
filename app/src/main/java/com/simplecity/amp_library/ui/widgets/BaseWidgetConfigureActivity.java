...
public abstract class BaseWidgetConfigureActivity extends BaseActivity implements
    ...
    // Removed seekBar field as per compile error suggestion

    private int backgroundColor;
    private int textColor;
    private boolean showAlbumArt;
    // Removed invertIcons field as per compile error suggestion
    ...
    public void updateWidgetUI() {
        ...
        updateWidgetTexts(widgetLayout);
        updateAlbumArt(widgetLayout);
    }

    private void updateColorsFromPrefs() {
        backgroundColor = prefs.getInt(BaseWidgetProvider.ARG_WIDGET_BACKGROUND_COLOR + appWidgetId, ContextCompat.getColor(this, R.color.white));
    ...
    private void updateWidgetTexts(View widgetLayout) {
    ...
    private void updateAlbumArt(View widgetLayout) {
    ...
    public void onColorSelection(@NonNull ColorChooserDialog dialog, @ColorInt int selectedColor) {
        if (dialog == textColorDialog) {
            handleTextColorSelection(selectedColor);
        } else if (dialog == backgroundColorDialog) {
            handleBackgroundColorSelection(selectedColor);
        }
    }

    private void handleTextColorSelection(@ColorInt int selectedColor) {
        ...
        if (fragment != null) {
            ...
            if (widgetView != null) {
                updateTextColors(widgetView, textColor);
            }
        }
    }

    private void handleBackgroundColorSelection(@ColorInt int selectedColor) {
    ...
    private void updateTextColors(View widgetView, @ColorInt int color) {
